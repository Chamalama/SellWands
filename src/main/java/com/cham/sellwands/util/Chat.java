...
public class Chat {
    ...
    public static Component[] translate(String... text) {
        return Arrays.stream(text).map(Chat::translate).toArray(Component[]::new);
    }
    ...
    public static List<String> translateToPrimitive(List<Component> component) {
        return component.stream().map(Chat::translateToPrimitive).toList();
    }
    ...
    public static List<String> translateToMiniMessage(List<Component> component) {
        return component.stream().map(Chat::translateToMiniMessage).toList();
    }
